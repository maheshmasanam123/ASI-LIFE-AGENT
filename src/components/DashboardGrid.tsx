    ...
    <div className="relative">
        ...
        >
          <div className="w-20 h-20 rounded-2xl bg-asi-bgTeritary flex items-center justify-center mb-6 border border-asi-border/50">
            <svg className="w-10 h-10 text-asi-textMuted" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2" />
            </svg>
          </div>
      ...
      >
        <div className="flex flex-wrap gap-3 justify-center">
          <button 
            onClick={() => { 
              // This will trigger agent creation through the orchestrator
          ...
          <button 
            ...
            onClick={() => {
              // Trigger system test
              const event = new CustomEvent('run-system-test');
              window.dispatchEvent(event);
            }}
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
