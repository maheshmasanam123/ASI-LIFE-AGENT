  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-display font-bold text-asi-text">Analytics</h1>
        <span className="text-sm text-asi-textMuted">System analytics and performance metrics</span>
      </div>
